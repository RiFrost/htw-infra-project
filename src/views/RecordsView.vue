<template>
  <div class="flex my-4">
    <div role="status" class="mx-auto" v-if="waitingForRes">
      <svg
        aria-hidden="true"
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
              ...
              >
                ...
                Architecto debitis explicabo excepturi ex facere a quis culpa
                voluptatum, aliquid dicta commodi iste esse veniam repellendus,
                sunt neque vel beatae nemo.
              </p>

              <label
                for="message"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400"
                >Your Text to Translate and convert to an Audio ...</label
              >
              <textarea
                id="message"
                v-model="text"
